-- Module: ESP (Originally module 'm')
...
function ESP:AddObjectListener(parent, options)
	local NewListener = function(c)
		if
			type(options.Type) == "string" and c:IsA(options.Type) or options.Type == nil
		then
...
function ESP:Add(obj, options)
	...
	local box = setmetatable({
		...
		PrimaryPart = options.PrimaryPart
			or obj.ClassName == "Model" and (obj.PrimaryPart or obj:FindFirstChild("HumanoidRootPart") or obj:FindFirstChildWhichIsA("BasePart"))
